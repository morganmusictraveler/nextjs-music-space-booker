...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'flex items-center justify-between w-full h-10 px-4 text-base font-normal text-[#707070]',
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <i className="fa-solid fa-chevron-down text-[14px] opacity-70"></i>
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'z-50 min-w-[8rem] overflow-hidden rounded-lg border border-[#e0e0e0] bg-white',
